...
<div class="modal fade" id="distributorModalExcell" tabindex="-1" aria-labelledby="distributorModalExcellLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="distributorModalExcellLabel">Upload Data Distributor (Excel)</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- Modal Body -->
            <div class="modal-body">
                <form id="distributorExcellForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
