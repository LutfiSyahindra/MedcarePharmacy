            ...
            <div class="card">
                <div class="card-body">
                    <div
                        ...
                        <div class="d-flex align-items-center mb-3 mb-md-0">
                            <div class="icon bg-primary bg-opacity-10 text-primary rounded-circle me-3 d-flex align-items-center justify-content-center"
                                ...
                                <i class="mdi mdi-view-list-outline mdi-24px"></i>
                            </div>
                            <div>
                                <h5 class="fw-bold text-primary mb-1">Data Master Sub Kategori Utama</h5>
                                <small class="text-muted">Kelola dan cari data Sub Ktegori Utama Obat dengan cepat</small>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2">
                            ...
                            <div class="input-group input-group-sm" style="width: 220px;">
                                ...
                                <input type="text" id="searchSubKategori" class="form-control border-start-0"
                                    placeholder="Cari Sub Kategori...">
                            </div>

                            <!-- Tombol Import Excel -->
                            <button type="button" class="btn btn-success btn-sm d-flex align-items-center"
                                data-bs-toggle="modal" data-bs-target="#subCategoryModalExcell">
                    ...
                    <div class="table-responsive">
                        <table id="tableSubKategori" class="table">
                            <thead>
                                <tr>
                                    <th>No</th>
                                    <th>Main Kategori</th>
