...
<div class="modal fade" id="subCategoryModalExcell" tabindex="-1" aria-labelledby="subCategoryModalExcellLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="subCategoryModalExcellLabel">Upload Sub Kategori Obat (Excel)</h5>
