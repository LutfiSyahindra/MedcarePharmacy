...
<div class="modal fade" id="mainCategoryModalExcell" tabindex="-1" aria-labelledby="mainCategoryModalExcellLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="mainCategoryModalExcellLabel">Upload Data Main Kategori Obat (Excel)</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- Modal Body -->
            <div class="modal-body">
                <form id="obatExcellForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
