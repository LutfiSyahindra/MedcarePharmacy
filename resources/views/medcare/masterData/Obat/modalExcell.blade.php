...
<div class="modal fade" id="obatModalExcell" tabindex="-1" aria-labelledby="obatModalExcellLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="obatModalExcellLabel">Upload Data Master Obat (Excel)</h5>
