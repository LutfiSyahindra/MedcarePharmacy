...
<div class="modal fade" id="satuanModalExcell" tabindex="-1" aria-labelledby="satuanModalExcellLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title" id="satuanModalExcellLabel">Upload Data Satuan (Excel)</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <!-- Modal Body -->
            <div class="modal-body">
                <form id="satuanExcellForm" enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
